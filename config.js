...
module.exports = {
  ...
  // ─── 마인크래프트 렐름 신청 (commands/마크.js) ──────────────────
  // 신청서 제출 시 참가용 임베드(승인/거절 버튼 포함)가 올라갈 채널. 반드시 실제 채널 ID로 채워야 한다.
  REALM_REVIEW_CHANNEL_ID: '1544315626456227880',
  // 승인 시 자동으로 지급할 마크 역할 ID. 비워두면([]나 '' 그대로) 역할 지급 없이 DM 안내만 보낸다.
  REALM_WHITELIST_ROLE_ID: '1427442085413388319',
