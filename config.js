...
module.exports = {
  ...
  ADMIN_IDS: ['457437911869161472', '1043750483522752512', '685917435601092643','689741810297208832'],

  // ─── 마인크래프트 렐름 신청 (forms/마크/, /신청서) ──────────────────
  // 신청서 제출 시 검토용 임베드(승인/거절 버튼 포함)가 올라갈 채널. 반드시 실제 채널 ID로 채워야 한다.
  REALM_REVIEW_CHANNEL_ID: '1544513687254204426',
  // 규칙이 적힌 스레드/메시지 — "신청하기"를 누르려면 이 메시지에 ✅ 이모지를 먼저 남겨야 한다.
  REALM_RULES_CHANNEL_ID: '1544655050767605760',
  REALM_RULES_MESSAGE_ID: '1544655055742050355',
  // 명단 관리 메뉴("관리" → "신청서 패널 새로고침")가 갱신할, 본서버 모집글에 이미 게시된 렐름
  // 신청서 패널 메시지. APPLY_DISABLED를 바꾼 뒤 이 메시지를 그 자리에서 다시 그리는 용도.
  // 채우지 않으면('') 새로고침이 "패널 메시지 설정 안 됨" 안내만 낸다.
  REALM_PANEL_CHANNEL_ID: '1535971639660122262',
  REALM_PANEL_MESSAGE_ID: '1544666604716171385',
